...
public class PublicClassifyPresenter extends BasePresenter<PublicClassifyView> implements BaseQuickAdapter.OnItemClickListener {
    ...
    public PublicClassifyPresenter(PublicClassifyView baseView, Activity activity) {
